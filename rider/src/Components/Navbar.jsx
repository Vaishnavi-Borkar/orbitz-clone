...
function Navbar() {
    return (
        <>
            <Box style={{ fontFamily: "Segoe UI", backgroundColor: "#00253c", color: "white", height: "80px", display: "flex" }}>
                ...
                <Box style={{ display: "flex", alignItems: "center" }}>
                    <HStack spacing="20px">
                        ...
                        <Link style={{ marginRight: "30px", textDecoration: "none", color: "white" }} to="/">Sign in</Link>
                    </HStack>
                </Box>
            ...
            <Box>
                {/* <img style={{ width: "100%", height: "300px" }} src="https://forever.travel-assets.com/flex/flexmanager/images/2021/11/01/ORB_Storefront_6_imgB_1400x600_20211028.jpg?impolicy=fcrop&w=900&h=225&q=mediumHigh" alt="travel" /> */}
                <Box style={{
                    width: "80%", height: "300px", backgroundColor: "black", margin: "auto", color: "white"
                }}>
